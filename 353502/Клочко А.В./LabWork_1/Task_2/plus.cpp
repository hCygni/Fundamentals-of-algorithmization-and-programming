...
void Plus::drawMoveEvent(QMouseEvent *event)
{
    ...
    points.emplace_back(centerPoint.x() + xRadius / 4, centerPoint.y() - yRadius);
    points.emplace_back(centerPoint.x() + xRadius / 4, centerPoint.y() - yRadius / 4);
    points.emplace_back(centerPoint.x() + xRadius, centerPoint.y() - yRadius / 4);
    points.emplace_back(centerPoint.x() + xRadius, centerPoint.y() + yRadius / 4);
    points.emplace_back(centerPoint.x() + xRadius / 4, centerPoint.y() + yRadius / 4);
    points.emplace_back(centerPoint.x() + xRadius / 4, centerPoint.y() + yRadius);
    points.emplace_back(centerPoint.x() - xRadius / 4, centerPoint.y() + yRadius);
...
void Plus::drawPaintEvent(QPainter *painter)
{
    painter->setPen(3);
    painter->drawPolygon(this->polygon);
}

void Plus::calculatePerimeter()
{
    this->perimeter = 0;
