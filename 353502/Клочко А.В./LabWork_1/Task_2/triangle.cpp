...
void Triangle::drawMoveEvent(QMouseEvent *event)
{
    ...
    points.emplace_back(centerPoint.x() + xRadius, centerPoint.y() + yRadius);
    points.emplace_back(centerPoint.x() - xRadius, centerPoint.y() + yRadius);
...
void Triangle::drawPaintEvent(QPainter *painter)
{
    painter->setPen(3);
